...
public class mirage_mid_cat
        extends AppCompatActivity
        implements mirage_mid_cat_step1.OnFragmentInteractionListener, mirage_mid_cat_step2.OnFragmentInteractionListener, mirage_mid_cat_vid.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final mirage_mid_cat_pagerAdapter adapter = new mirage_mid_cat_pagerAdapter(getSupportFragmentManager(),tabLayout2.getTabCount());
