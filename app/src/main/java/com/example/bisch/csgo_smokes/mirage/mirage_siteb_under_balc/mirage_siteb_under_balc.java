...
public class mirage_siteb_under_balc
        extends AppCompatActivity
        implements mirage_siteb_under_balc_step1.OnFragmentInteractionListener, mirage_siteb_under_balc_step2.OnFragmentInteractionListener, mirage_siteb_under_balc_vid.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final mirage_siteb_under_balc_pagerAdapter adapter = new mirage_siteb_under_balc_pagerAdapter(getSupportFragmentManager(),tabLayout2.getTabCount());
