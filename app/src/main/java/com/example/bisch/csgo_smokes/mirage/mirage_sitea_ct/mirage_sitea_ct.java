...
public class mirage_sitea_ct
        ...
        implements mirage_sitea_ct_step1.OnFragmentInteractionListener,
        mirage_sitea_ct_step2.OnFragmentInteractionListener,
        mirage_sitea_ct_vid.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final mirage_sitea_ct_pagerAdapter adapter = new mirage_sitea_ct_pagerAdapter(getSupportFragmentManager(),tabLayout2.getTabCount());
